      ...
      image.onload = () => {
        ...
        if (imageWidth < 500 || imageHeight < 500) {
          Swal.fire({
            ...
            // Calculate font size based on the multiplier
            const dynamicFontSize = Math.min(imageWidth, imageHeight) * multiplier;
            const clampedFontSize = Math.max(16, Math.min(dynamicFontSize, 200));
        setFontSize(`${clampedFontSize}px`);   
        console.log(clampedFontSize);
  ...
  const handleDownload = async () => {
    ...
    if (container) {
      ...
      img.onload = async () => {
        ...
        const gradient = ctx.createLinearGradient(0, -canvas.height * 0.12, 0, canvas.height * 0.12);
  ...
  return (
    <div className="wasted-main-container">
      ...
      <div className="file-input">
        ...
        />
        <label htmlFor="file" dangerouslySetInnerHTML={{__html: uploadLabel}}></label>
        {image && (
      ...
      {image && (
        <>
          <div className="wasted-image-container">
            ...
            />
            <div className="wasted-overlay-effect" style={{ height: overlayHeight }}></div>
          ...
          <svg width="0" height="0">
            <defs>
              <mask id="wasted-mask" maskUnits="objectBoundingBox" maskContentUnits="objectBoundingBox">
